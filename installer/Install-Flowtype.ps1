...
try {
    ...
    if ($installedVersion -notmatch '^1\.3\.6\.') {
        throw "Expected Flowtype 1.3.6.x but found $installedVersion. Extract the new ZIP into an empty folder and retry."
    }
    ...
    [Windows.Forms.MessageBox]::Show(
        "Flowtype 1.3.6 is installed and the new executable is running.`r`n`r`nHold Win + Ctrl together to dictate anywhere.",
        'Flowtype 1.3.6 installed',
